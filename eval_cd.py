...
def main():
    ...
    parser.add_argument('--project_name', default='CD_base_transformer_pos_s4_dd8_LEVIR_b8_lr0.01_trainval_test_200_linear', type=str)
    ...
    for batch in dataloader:
        img1 = batch['A']
        print("LEVIR sample - min:", img1.min(), "max:", img1.max(), "mean:", img1.mean())
        break
